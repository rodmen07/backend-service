//! Authentication helpers for API bearer-token validation.
...
/// HTTP header used for bearer-token authentication.
pub const AUTH_HEADER: &str = "Authorization";

/// Token scheme used for auth middleware.
...
/// Returns the canonical header format for authenticated requests.
///
/// # Parameters
/// - None.
///
